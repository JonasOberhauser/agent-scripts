...
//! ```
//!
//! `error unprivileged` is the signal for clients to surface their
//! remediation commands (install the socket-activated unit permanently,
//! or relaunch hashd privileged until its next restart).
//!
//! # Deployment
//!
